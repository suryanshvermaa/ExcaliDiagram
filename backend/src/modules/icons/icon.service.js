'use strict'
/**
 * Icon storage service — auto-switches between local filesystem (desktop)
 * and S3/MinIO (web/server) based on the DESKTOP_MODE env var.
 */

if (process.env.DESKTOP_MODE === 'true') {
  module.exports = require('../../config/localFs')
} else {
  const {
    PutObjectCommand,
    GetObjectCommand,
